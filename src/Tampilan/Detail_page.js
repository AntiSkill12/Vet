        ...
        <View>
            ...
            <ScrollView>
                ...
                <View style={{backgroundColor:'#FFFFFF',paddingTop:20, paddingBottom:20,}}>
                    ...
                    <Image source={require('../Gambar/image.png')} style={styles.image} />
                    ...
                    <View style={styles.container3}>
                    <Image source={require('../Gambar/image2.png')} style={styles.image} />
                    ...
                    <View style={styles.daerah}>
                        ...
                        <View style={styles.waktu}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('Tambah_Hewan')}>
                    ...
                    onPress={() => navigation.navigate('Success_bar')}>
